...
// 필요할때 그때 그때 추출하면 됨... 필요할 때 알려줌
public class Utility {
  // 서비스시에는 도메인으로 변경됨.
  private static final String root = "/mp";
  ...
  /**
   * 내용중에 특수문자 표현을 위해 HTML 특수문자로 변환합니다. 예) 테이블 태그
   * <TABLE> &lt;TABLE&gt;
   */
  public static synchronized String convertChar(String str) {
    ...
    str = str.replaceAll("<", "&lt;");
    str = str.replaceAll(">", "&gt;");
    str = str.replaceAll("'", "&apos;");   // ' , 태그의 기능을 없어짐..
  ...
  // 줄 바꾸기, DBMS -> TextArea
  public static String convertCharTextArea(String str) {
