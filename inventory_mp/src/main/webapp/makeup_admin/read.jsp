...
<DIV class='title'><%=dto.getMname() %> 관리자 정보</DIV>
...
<DIV class='bottom'>
  <input type="button" value="관리자 정보 수정" 
         onclick="location.href='./updateForm.jsp?id=<%=id%>'">
  <input type="button" value="관리자 사진 수정" 
         onclick="location.href='./updateFileForm.jsp?id=<%=id%>'">
  <input type="button" value="관리자 목록" onclick="location.href='./list.jsp'">
