...
<body>
<DIV class="title">고객지원자료실 답변 등록 처리</DIV>

<DIV class='msg'> 
<%
if (dao.reply(dto) == 1){%>
  답변을 등록했습니다.<br><br>
  <input type='button' value='계속 답변 등록' onclick="location.href='./replyForm.jsp?cdatano=<%=cdatano %>&col=<%=col %>&word=<%=word %>&nowPage=<%=nowPage %>'">
