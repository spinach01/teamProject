...
if (msg1 != null){  // 메시지가 있는지 검사
  out.println("<DD> <img src='"+request.getAttribute("root")+"/mpgroup/images/bu01.gif'> " + msg1);//단어 점(자동 줄바꿈)  
}
if (msg2 != null){
  out.println("<DD> <img src='"+request.getAttribute("root")+"/mpgroup/images/bu01.gif'> " + msg2);  
}
if (msg3 != null){
  out.println("<DD> <img src='"+request.getAttribute("root")+"/mpgroup/images/bu01.gif'> " + msg3);  
}
if (msg4 != null){
  out.println("<DD> <img src='"+request.getAttribute("root")+"/mpgroup/images/bu01.gif'> " + msg4);  
}
if (msg5 != null){
  out.println("<DD> <img src='"+request.getAttribute("root")+"/mpgroup/images/bu01.gif'> " + msg5);  
}
